...
const copy = {
  en: {
    ...
    statusBody: "This free static site does not collect personal data. New stories can be added by replacing the story data file.", browseAll: "Browse all stories", archiveCount: "STORIES",
  ...
  zh: {
    ...
    statusBody: "这个免费静态网站不收集个人资料。以后添加新故事，只需替换故事数据文件。", browseAll: "浏览全部故事", archiveCount: "篇故事",
